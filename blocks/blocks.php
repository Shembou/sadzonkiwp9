...
function create_blocks_on_init() {
	...
	if ( function_exists( 'wp_register_block_types_from_metadata_collection' ) ) {
		wp_register_block_types_from_metadata_collection( __DIR__ . '/build/atoms', __DIR__ . '/build/blocks-manifest.php' );
		return;
	}
	...
	if ( function_exists( 'wp_register_block_metadata_collection' ) ) {
		wp_register_block_metadata_collection( __DIR__ . '/build/atoms', __DIR__ . '/build/blocks-manifest.php' );
	}
	/**
